...
_lr_productions = [
  ...
  ('expression -> boolExp','expression',1,'p_expression','rust_parser.py',228),
  ('basicExp -> IDVAR','basicExp',1,'p_basic','rust_parser.py',236),
  ('basicExp -> INTVR','basicExp',1,'p_basic','rust_parser.py',237),
  ('basicExp -> STRNG','basicExp',1,'p_basic','rust_parser.py',238),
  ('identifier -> IDVAR','identifier',1,'p_id','rust_parser.py',247),
  ('identifier -> INTVR','identifier',1,'p_id','rust_parser.py',248),
  ('assignmentExp -> identifier sumOp basicExp','assignmentExp',3,'p_assignment_expression','rust_parser.py',257),
  ('assignmentExp -> identifier sumOp assignmentExp','assignmentExp',3,'p_assignment_expression','rust_parser.py',258),
  ('comparisonExp -> basicExp relop basicExp','comparisonExp',3,'p_compExp','rust_parser.py',269),
  ('comparisonExp -> basicExp relop comparisonExp','comparisonExp',3,'p_compExp','rust_parser.py',270),
  ('relop -> LESST','relop',1,'p_relop','rust_parser.py',278),
  ('relop -> LSSEQ','relop',1,'p_relop','rust_parser.py',279),
  ('relop -> GREAT','relop',1,'p_relop','rust_parser.py',280),
  ('relop -> GRTEQ','relop',1,'p_relop','rust_parser.py',281),
  ('relop -> EQUAL','relop',1,'p_relop','rust_parser.py',282),
  ('relop -> UNEQL','relop',1,'p_relop','rust_parser.py',283),
  ('relop -> EQLTO','relop',1,'p_relop','rust_parser.py',284),
  ('sumOp -> ADDOP','sumOp',1,'p_sumOp','rust_parser.py',293),
  ('sumOp -> SUBOP','sumOp',1,'p_sumOp','rust_parser.py',294),
  ('sumOp -> DEROP','sumOp',1,'p_sumOp','rust_parser.py',295),
  ('sumOp -> QUOOP','sumOp',1,'p_sumOp','rust_parser.py',296),
  ('sumOp -> EQUAL','sumOp',1,'p_sumOp','rust_parser.py',297),
  ('sumOp -> REMOP','sumOp',1,'p_sumOp','rust_parser.py',298),
  ('selectionStmt -> IF expression EQUAL block','selectionStmt',4,'p_selectionStmt','rust_parser.py',307),
  ('selectionStmt -> IF expression EQUAL block ELSE','selectionStmt',5,'p_selectionStmt','rust_parser.py',308),
  ('iterationStmt -> FOR expression IN expression','iterationStmt',4,'p_iterationStmt','rust_parser.py',317),
  ('iterationStmt -> WHILE expression EQUAL expression','iterationStmt',4,'p_iterationStmt','rust_parser.py',318),
  ('iterationStmt -> WHILE expression LESST expression','iterationStmt',4,'p_iterationStmt','rust_parser.py',319),
  ('iterationStmt -> WHILE expression GREAT expression','iterationStmt',4,'p_iterationStmt','rust_parser.py',320),
  ('inputStmt -> STDIN OPENP stmt CLOSP','inputStmt',4,'p_input_stmt','rust_parser.py',337),
  ('outputStmt -> PRINTLN OPENP stmt CLOSP','outputStmt',4,'p_output_stmt','rust_parser.py',344),
  ('boolExp -> TRUE','boolExp',1,'p_boolExp','rust_parser.py',351),
  ('boolExp -> FALSE','boolExp',1,'p_boolExp','rust_parser.py',352),
]
